	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		okSetttingChangesButton.setOnClickListener {
			...
			if (wifiChecker.checkWifi()) {
				...
				intent.putExtra(ApplicationSettings.DAYSFORECAST, setting.first)
				intent.putExtra(ApplicationSettings.INTERVAL_UPDATES, setting.second)
				intent.putExtra(ApplicationSettings.CITY, setting.third)
